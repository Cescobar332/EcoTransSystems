    ...
    <main id="main">
        <div class="columna">
            <div class="card" style="width: 18rem;">
                <img src="resources\IMG\robot.jpeg" class="card-img-top img-fluid" alt="...">
        ...
        <div class="columna">
            <div class="card" style="width: 18rem;">
                <img src="resources\IMG\apps.jpeg" class="card-img-top" alt="...">
                <div class="card-body card-cam">
        ...
        <div class="columna">
            <div class="card" style="width: 18rem;">
                <img src="resources\IMG\emergencia.jpg" class="card-img-top" alt="...">
                <div class="card-body card-cam">
        ...
        <div class="columna">
            <div class="card" style="width: 18rem;">
                <img src="resources\IMG\bici.jpg" class="card-img-top" alt="...">
                <div class="card-body card-cam">
