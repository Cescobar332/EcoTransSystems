...
<body>
    ...
    <main>
        <section class="contacto">
            ...
            <ul>
                <li>
                    <img src="resources\IMG\email-icon.png" alt="Email icon">
                    <span>Email: mvillamizar666@unab.edu.co</span>
                </li>
                <li>
                    <span>Teléfono:
                        <ul>
                            <li><img src="resources\IMG\phone-icon.png" alt="Phone icon"> 3505030233</li>
                            <li><img src="resources\IMG\phone-icon.png" alt="Phone icon"> 3166071650</li>
                            <li><img src="resources\IMG\phone-icon.png" alt="Phone icon"> 3173105375</li>
                        </ul>
                    </span>
                </li>
                <li>
                    <img src="resources\IMG\address-icon.png" alt="Address icon">
